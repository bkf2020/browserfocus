...
function startBlocking() {
	...
	chrome.storage.sync.set({taskName: taskName});
...
chrome.storage.sync.get(['taskName'], function(result) {
	if (result.taskName !== undefined) {
		document.getElementById("task-name-h2").innerText = "Your task: " + result.taskName;
		document.getElementById("task-name").value = result.taskName;
	}
});
